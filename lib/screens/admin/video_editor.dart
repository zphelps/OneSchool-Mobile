...
class _VideoEditorState extends State<VideoEditor> {
  ...
  void _openCropScreen() => RoutingUtil.push(context, CropScreen(controller: _controller));
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(systemOverlayStyle: SystemUiOverlayStyle.light, toolbarHeight: 0, backgroundColor: Colors.black),
